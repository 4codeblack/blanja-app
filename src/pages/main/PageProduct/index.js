                ...
                <div className='d-flex flex-row mt-3'>
                    ...
                    <div className='w-50 d-flex w-50 flex-column'>
                        ...
                        <div className='d-flex flex-row'>
                            <Button className='border border-dark bg-white w-25 p-2 rounded-pill'>Chat</Button>
                            <Button className='border border-dark bg-white w-25 p-2 rounded-pill mx-2'>Add bag</Button>
                        </div>
                        <Button className='bg-red w-50 border-0 p-2 text-white rounded-pill mt-3' onClick={handleBuy}>Buy now</Button>
                    </div>
                </div>
